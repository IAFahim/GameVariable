...
namespace Variable.Experience
{
        ...
        IConvertible
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator int(ExperienceInt value) => value.Current;

        /// <inheritdoc/>
        public override string ToString() => $"Lvl {Level} ({Current}/{Max})";
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => obj is ExperienceInt other && Equals(other);

        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(ExperienceInt other) => Current == other.Current && Max == other.Max && Level == other.Level;
        ...
        /// <inheritdoc/>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override int GetHashCode() => HashCode.Combine(Current, Max, Level);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(ExperienceInt left, ExperienceInt right) => left.Equals(right);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator <(ExperienceInt left, ExperienceInt right) => left.CompareTo(right) < 0;
