...
**Variable.Range** provides structs for defining numerical ranges (Min/Max) and generating random values within them.
Essential for damage rolls, loot tables, and procedural generation.
